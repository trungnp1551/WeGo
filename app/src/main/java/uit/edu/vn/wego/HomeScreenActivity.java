...
public class HomeScreenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(this).load("https://ezcomclass.com/wp-content/uploads/2020/12/do-dung-can-thiet.jpg").centerCrop().into(travel_tips_background_imageview);
