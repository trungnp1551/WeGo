...
public class ReviewPostShow extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        unlike_button.setOnClickListener(v -> {
        ...
        postComment_button.setOnClickListener(v -> {
        ...
        image.setOnClickListener(v -> new ImageViewer.Builder(ReviewPostShow.this, item.getImgURL())
                .show());
    }
...
//        finish();
    ...
    private boolean userLike_UnLikePost(String status) {
        ...
        String url = "http://172.16.0.32:3000/user/" + itemUser.getId() + "/"+status+"/" + item.getId();
...
//                startActivity(intent);
    ...
    private void userCommentPost(String comment) {
        ...
        String url = "http://172.16.0.32:3000/user/" + itemUser.getId() + "/comment/" + item.getId();
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST, url, null, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                try {
