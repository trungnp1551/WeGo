...
public class EditProfileActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        change_profile_photo_btn.setOnClickListener(v -> {
        ...
        change_password_info_btn.setOnClickListener(v -> {
        ...
        apply_change_password_btn.setOnClickListener(v -> {
    ...
    private void updateProfile(String fullName, String email) {
        ...
        String url = "http:/:3000/user/" + itemUser.getId();
    ...
    private void changePassword(String dataSubmit) {
        ...
        String url = "http://172.16.0.32:3000/user/" + itemUser.getId() + "/changePassword";
    ...
    public void logOut() {
        String url = "http://172.16.0.32:3000/user/" + itemUser.getId() + "/logout";
